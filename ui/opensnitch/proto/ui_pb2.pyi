...
class Action(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    SUBSCRIPTIONS: _ClassVar[Action]

class SubscriptionOperation(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    SUBSCRIPTION_OPERATION_UNSPECIFIED: _ClassVar[SubscriptionOperation]
    SUBSCRIPTION_OPERATION_LIST: _ClassVar[SubscriptionOperation]
    SUBSCRIPTION_OPERATION_APPLY: _ClassVar[SubscriptionOperation]
    SUBSCRIPTION_OPERATION_DELETE: _ClassVar[SubscriptionOperation]
    SUBSCRIPTION_OPERATION_REFRESH: _ClassVar[SubscriptionOperation]
    SUBSCRIPTION_OPERATION_DEPLOY: _ClassVar[SubscriptionOperation]
...
class SubscriptionStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    SUBSCRIPTION_STATUS_PENDING: _ClassVar[SubscriptionStatus]
    SUBSCRIPTION_STATUS_READY: _ClassVar[SubscriptionStatus]
    SUBSCRIPTION_STATUS_SYNCING: _ClassVar[SubscriptionStatus]
...
SUBSCRIPTION_OPERATION_UNSPECIFIED: SubscriptionOperation
SUBSCRIPTION_OPERATION_LIST: SubscriptionOperation
SUBSCRIPTION_OPERATION_APPLY: SubscriptionOperation
SUBSCRIPTION_OPERATION_DELETE: SubscriptionOperation
SUBSCRIPTION_OPERATION_REFRESH: SubscriptionOperation
SUBSCRIPTION_OPERATION_DEPLOY: SubscriptionOperation
SUBSCRIPTION_STATUS_UNSPECIFIED: SubscriptionStatus
SUBSCRIPTION_STATUS_PENDING: SubscriptionStatus
SUBSCRIPTION_STATUS_READY: SubscriptionStatus
SUBSCRIPTION_STATUS_SYNCING: SubscriptionStatus
...
class Statistics(_message.Message):
    ...
    SUBSCRIPTION_TOTAL_FIELD_NUMBER: _ClassVar[int]
    SUBSCRIPTION_READY_FIELD_NUMBER: _ClassVar[int]
    SUBSCRIPTION_ERROR_FIELD_NUMBER: _ClassVar[int]
    daemon_version: str
    rules: int
    uptime: int
    dns_responses: int
    ...
    subscription_error: int
    def __init__(self, daemon_version: _Optional[str] = ..., rules: _Optional[int] = ..., uptime: _Optional[int] = ..., dns_responses: _Optional[int] = ..., connections: _Optional[int] = ..., ignored: _Optional[int] = ..., accepted: _Optional[int] = ..., dropped: _Optional[int] = ..., rule_hits: _Optional[int] = ..., rule_misses: _Optional[int] = ..., by_proto: _Optional[_Mapping[str, int]] = ..., by_address: _Optional[_Mapping[str, int]] = ..., by_host: _Optional[_Mapping[str, int]] = ..., by_port: _Optional[_Mapping[str, int]] = ..., by_uid: _Optional[_Mapping[str, int]] = ..., by_executable: _Optional[_Mapping[str, int]] = ..., events: _Optional[_Iterable[_Union[Event, _Mapping]]] = ..., subscription_total: _Optional[int] = ..., subscription_ready: _Optional[int] = ..., subscription_error: _Optional[int] = ...) -> None: ...
...
class Subscription(_message.Message):
    ...
    last_updated: str
    last_error: str
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., url: _Optional[str] = ..., filename: _Optional[str] = ..., groups: _Optional[_Iterable[str]] = ..., enabled: _Optional[bool] = ..., format: _Optional[str] = ..., interval_seconds: _Optional[int] = ..., timeout_seconds: _Optional[int] = ..., max_bytes: _Optional[int] = ..., node: _Optional[str] = ..., status: _Optional[_Union[SubscriptionStatus, str]] = ..., last_updated: _Optional[str] = ..., last_error: _Optional[str] = ...) -> None: ...
...
class SubscriptionRequest(_message.Message):
    ...
    force: bool
    def __init__(self, operation: _Optional[_Union[SubscriptionOperation, str]] = ..., subscriptions: _Optional[_Iterable[_Union[Subscription, _Mapping]]] = ..., targets: _Optional[_Iterable[str]] = ..., force: _Optional[bool] = ...) -> None: ...
...
class SubscriptionReply(_message.Message):
    ...
    message: str
    accepted: bool
    def __init__(self, operation: _Optional[_Union[SubscriptionOperation, str]] = ..., subscriptions: _Optional[_Iterable[_Union[Subscription, _Mapping]]] = ..., errors: _Optional[_Iterable[str]] = ..., message: _Optional[str] = ..., accepted: _Optional[bool] = ...) -> None: ...
...
class Notification(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., clientName: _Optional[str] = ..., serverName: _Optional[str] = ..., type: _Optional[_Union[Action, str]] = ..., data: _Optional[str] = ..., rules: _Optional[_Iterable[_Union[Rule, _Mapping]]] = ..., sysFirewall: _Optional[_Union[SysFirewall, _Mapping]] = ..., subscription: _Optional[_Union[SubscriptionRequest, _Mapping]] = ...) -> None: ...
...
class NotificationReply(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., code: _Optional[_Union[NotificationReplyCode, str]] = ..., data: _Optional[str] = ..., subscription: _Optional[_Union[SubscriptionReply, _Mapping]] = ...) -> None: ...
