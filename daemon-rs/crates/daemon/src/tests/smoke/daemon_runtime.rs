...
use crate::{
    ...
    models::{
        command::rpc::{ClientCommand, TaskNotification},
...
fn build_test_daemon_with_tunables(bus: Bus, tunables: RuntimeTunables) -> Daemon {
    ...
    Daemon {
        runtime: Arc::new(DaemonRuntime {
            ...
            tunables,
            shutdown: CancellationToken::new(),
            metrics_config: crate::models::metrics::config::MetricsConfig::default(),
            metrics_cli: crate::models::metrics::config::MetricsCliOverrides::default(),
